# Load the libraries
from llama_index import set_global_service_context, VectorStoreIndex, Document

from llama_utils.llama_index_utils import (
...
def prep_llama_indexes():
    ...
    # Load the documents
    page_separated_documents = load_documents(CFG.documents_dir)
    ...
    index = VectorStoreIndex.from_documents(
        [merged_document], service_context=service_context
    )
    # Save the index
    ...
    print(f"Index of Page-wise RAG is saved in {CFG.pagewise_rag_index_save_dir}.\n")
    # ==================================
    ...
    print(f"Index of Sentence Retrieval is saved in {CFG.sentence_index_save_dir}.\n")
    # ======================================
    # Prepare Auto-merging retrieval index
    # ======================================
    print(
        "Processing the documents and creating the index for Auto-merging Retrieval..."
    )
