...
class LoadConfig:
    ...
    def __init__(self) -> None:
        ...
        # basic_rag
        self.basic_rag_index_save_dir: str = app_config["llama_index_cfg"]["basic_rag"][
            "index_save_dir"
        ]

        # pagewise_rag
        self.pagewise_rag_index_save_dir: str = app_config["llama_index_cfg"][
            "pagewise_rag"
        ]["index_save_dir"]

        # sentence_retrieval
        self.sentence_index_save_dir: str = app_config["llama_index_cfg"][
            "sentence_retrieval"
        ]["index_save_dir"]
        ...
        self.sentence_retrieval_rerank_top_n: int = app_config["llama_index_cfg"][
            "sentence_retrieval"
        ]["rerank_top_n"]
        ...
        self.chunk_sizes: int = app_config["llama_index_cfg"]["auto_merging_retrieval"][
            "chunk_sizes"
        ]
        self.auto_merging_retrieval_similarity_top_k: int = app_config[
            "llama_index_cfg"
